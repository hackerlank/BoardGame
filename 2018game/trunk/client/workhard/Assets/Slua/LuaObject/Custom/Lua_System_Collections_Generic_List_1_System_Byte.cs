...
public class Lua_System_Collections_Generic_List_1_System_Byte : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			System.Collections.Generic.List<System.Byte> o;
			if(argc==1){
				o=new System.Collections.Generic.List<System.Byte>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<System.Byte>))){
				System.Collections.Generic.IEnumerable<System.Byte> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<System.Byte>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Add(IntPtr l) {
		try {
			System.Collections.Generic.List<System.Byte> self=(System.Collections.Generic.List<System.Byte>)checkSelf(l);
			System.Byte a1;
			checkType(l,2,out a1);
			self.Add(a1);
			pushValue(l,true);
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Byte a1;
				checkType(l,2,out a1);
				System.Collections.Generic.IComparer<System.Byte> a2;
				...
				System.Collections.Generic.IComparer<System.Byte> a4;
	...
	static public int Exists(IntPtr l) {
		try {
			System.Collections.Generic.List<System.Byte> self=(System.Collections.Generic.List<System.Byte>)checkSelf(l);
			System.Predicate<System.Byte> a1;
	...
	static public int FindIndex(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				System.Predicate<System.Byte> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Predicate<System.Byte> a3;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<System.Byte> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<System.Byte>))){
				System.Collections.Generic.List<System.Byte> self=(System.Collections.Generic.List<System.Byte>)checkSelf(l);
				System.Comparison<System.Byte> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IComparer<System.Byte>))){
				System.Collections.Generic.List<System.Byte> self=(System.Collections.Generic.List<System.Byte>)checkSelf(l);
				System.Collections.Generic.IComparer<System.Byte> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<System.Byte> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"List<<System.Byte, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089>>");
		addMember(l,Add);
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<System.Byte>));
	}
}
