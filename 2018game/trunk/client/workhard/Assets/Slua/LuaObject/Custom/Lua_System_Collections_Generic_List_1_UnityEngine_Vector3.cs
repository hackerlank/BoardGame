...
public class Lua_System_Collections_Generic_List_1_UnityEngine_Vector3 : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			System.Collections.Generic.List<UnityEngine.Vector3> o;
			if(argc==1){
				o=new System.Collections.Generic.List<UnityEngine.Vector3>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<UnityEngine.Vector3>))){
				System.Collections.Generic.IEnumerable<UnityEngine.Vector3> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<UnityEngine.Vector3>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				UnityEngine.Vector3 a1;
				checkType(l,2,out a1);
				System.Collections.Generic.IComparer<UnityEngine.Vector3> a2;
				...
				System.Collections.Generic.IComparer<UnityEngine.Vector3> a4;
	...
	static public int Exists(IntPtr l) {
		try {
			System.Collections.Generic.List<UnityEngine.Vector3> self=(System.Collections.Generic.List<UnityEngine.Vector3>)checkSelf(l);
			System.Predicate<UnityEngine.Vector3> a1;
	...
	static public int FindIndex(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				System.Predicate<UnityEngine.Vector3> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Predicate<UnityEngine.Vector3> a3;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<UnityEngine.Vector3> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<UnityEngine.Vector3>))){
				System.Collections.Generic.List<UnityEngine.Vector3> self=(System.Collections.Generic.List<UnityEngine.Vector3>)checkSelf(l);
				System.Comparison<UnityEngine.Vector3> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IComparer<UnityEngine.Vector3>))){
				System.Collections.Generic.List<UnityEngine.Vector3> self=(System.Collections.Generic.List<UnityEngine.Vector3>)checkSelf(l);
				System.Collections.Generic.IComparer<UnityEngine.Vector3> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<UnityEngine.Vector3> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<UnityEngine.Vector3>));
	}
}
