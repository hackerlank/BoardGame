...
public class Lua_System_Collections_Generic_List_1_WWWRequest : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			System.Collections.Generic.List<WWWRequest> o;
			if(argc==1){
				o=new System.Collections.Generic.List<WWWRequest>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<WWWRequest>))){
				System.Collections.Generic.IEnumerable<WWWRequest> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<WWWRequest>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<WWWRequest>))){
				System.Collections.Generic.List<WWWRequest> self=(System.Collections.Generic.List<WWWRequest>)checkSelf(l);
				System.Comparison<WWWRequest> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IComparer<WWWRequest>))){
				System.Collections.Generic.List<WWWRequest> self=(System.Collections.Generic.List<WWWRequest>)checkSelf(l);
				System.Collections.Generic.IComparer<WWWRequest> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<WWWRequest> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<WWWRequest>));
	}
}
