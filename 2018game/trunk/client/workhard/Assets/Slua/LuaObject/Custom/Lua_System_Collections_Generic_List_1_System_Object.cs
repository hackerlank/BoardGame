...
public class Lua_System_Collections_Generic_List_1_System_Object : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(argc==1){
				o=new System.Collections.Generic.List<System.Object>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<object>))){
				System.Collections.Generic.IEnumerable<System.Object> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<System.Object>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Add(IntPtr l) {
		try {
			System.Collections.Generic.List<System.Object> self=(System.Collections.Generic.List<System.Object>)checkSelf(l);
			System.Object a1;
			checkType(l,2,out a1);
			self.Add(a1);
			pushValue(l,true);
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Object a1;
				checkType(l,2,out a1);
				System.Collections.Generic.IComparer<System.Object> a2;
				...
				System.Collections.Generic.IComparer<System.Object> a4;
	...
	static public int FindIndex(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				System.Predicate<System.Object> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Predicate<System.Object> a3;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<System.Object> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<object>))){
				System.Collections.Generic.List<System.Object> self=(System.Collections.Generic.List<System.Object>)checkSelf(l);
				System.Comparison<System.Object> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IComparer<object>))){
				System.Collections.Generic.List<System.Object> self=(System.Collections.Generic.List<System.Object>)checkSelf(l);
				System.Collections.Generic.IComparer<System.Object> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<System.Object> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<System.Object>));
	}
}
