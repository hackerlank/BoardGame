...
public class Lua_DG_Tweening_TweenExtensions : LuaObject {
	...
	static public int Complete_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function Complete to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int Pause_s(IntPtr l) {
		try {
			DG.Tweening.Tween a1;
			checkType(l,1,out a1);
			var ret=DG.Tweening.TweenExtensions.Pause<DG.Tweening.Tween>(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int Play_s(IntPtr l) {
		try {
			DG.Tweening.Tween a1;
			checkType(l,1,out a1);
			var ret=DG.Tweening.TweenExtensions.Play<DG.Tweening.Tween>(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
