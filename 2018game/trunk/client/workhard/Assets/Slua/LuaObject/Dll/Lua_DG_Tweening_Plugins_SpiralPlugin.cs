...
public class Lua_DG_Tweening_Plugins_SpiralPlugin : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.SpiralPlugin o;
			o=new DG.Tweening.Plugins.SpiralPlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Reset(IntPtr l) {
		try {
			DG.Tweening.Plugins.SpiralPlugin self=(DG.Tweening.Plugins.SpiralPlugin)checkSelf(l);
			DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.SpiralOptions> a1;
	...
	static public int GetSpeedBasedDuration(IntPtr l) {
		try {
			DG.Tweening.Plugins.SpiralPlugin self=(DG.Tweening.Plugins.SpiralPlugin)checkSelf(l);
			DG.Tweening.Plugins.SpiralOptions a1;
	...
	static public int Get_s(IntPtr l) {
		try {
			var ret=DG.Tweening.Plugins.SpiralPlugin.Get();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_DefaultDirection(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,DG.Tweening.Plugins.SpiralPlugin.DefaultDirection);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.SpiralPlugin");
		addMember(l,Reset);
		addMember(l,SetFrom);
		...
		addMember(l,Get_s);
		addMember(l,"DefaultDirection",get_DefaultDirection,null,false);
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.SpiralPlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.SpiralOptions>));
	}
}
