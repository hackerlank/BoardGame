...
public class Lua_DG_Tweening_DOTween : LuaObject {
	...
	static public int To_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function To to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int Shake_s(IntPtr l) {
		try {
			...
			if(argc==7){
				...
				var ret=DG.Tweening.DOTween.Shake(a1,a2,a3,a4,a5,a6,a7,a8);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function Shake to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int KillAll_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function KillAll to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int PlayBackwards_s(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Object a2;
				checkType(l,2,out a2);
				var ret=DG.Tweening.DOTween.PlayBackwards(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function PlayBackwards to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int PlayForward_s(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Object a2;
				checkType(l,2,out a2);
				var ret=DG.Tweening.DOTween.PlayForward(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function PlayForward to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int Restart_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function Restart to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
