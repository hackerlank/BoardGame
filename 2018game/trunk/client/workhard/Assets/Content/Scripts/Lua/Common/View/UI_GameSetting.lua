...
--close self param
local CLOSE_SELF_PARAM = ci.GetUICloseParam().new(false, Common.MENU_SETTING) 
...
function tbclass:Init()
    ...
    btn = transform:Find("Panel/btns/btn_logout"):GetComponent("Button")
    btn.onClick:AddListener(onClickLogoutBtn)
    table.insert(tb_btns, btn)
