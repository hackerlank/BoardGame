--[[
  * ui mediator class:: UI_UserDetailMediator
...
local mediator = class('UI_UserDetailMediator',pm.Mediator)
...
function mediator:Opened(param)
    ...
    self.viewComponent:FreshWindow(loginProxy:GetUserName(), loginProxy:GetUserId(), loginProxy:GetHeadImage(), nil , loginProxy:GetRoomCard(), loginProxy:GetUserIp())
end 
