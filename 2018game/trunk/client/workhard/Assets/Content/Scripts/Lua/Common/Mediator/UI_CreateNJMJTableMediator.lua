--[[
  * ui mediator class:: UI_CreateCDMJTableMediator
...
local mediator = class('UI_CreateCDMJTableMediator',pm.Mediator)
...
function mediator:Opened(param)
    ...
    self.viewComponent:SwithMode(ERoomMode.ERM_njmj)
end 
