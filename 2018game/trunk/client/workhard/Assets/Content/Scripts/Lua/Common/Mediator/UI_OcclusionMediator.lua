--[[
  * ui mediator class:: UI_OcclusionMediator
...
local mediator = class('UI_OcclusionMediator',pm.Mediator)
...
function mediator:OnRestore()
    if self.viewComponent and self.viewComponent.OnRestore then
...
function mediator:OnDisable()
    if self.viewComponent and self.viewComponent.OnDisable then
