--[[
  * ui mediator class:: UI_DuplicateOkMediator
...
local mediator = class('UI_DuplicateOkMediator',pm.Mediator)
...
function mediator:listNotificationInterests()
    ...
    table.insert(notification, Common.LAUNCH_THIRD_APP_OK)
	return notification
end
...
function mediator:handleNotification(notification)
    ...
    elseif Common.LAUNCH_THIRD_APP_OK == name then 
        self.viewComponent:NtfLaunchAppOk()
    end 
end
