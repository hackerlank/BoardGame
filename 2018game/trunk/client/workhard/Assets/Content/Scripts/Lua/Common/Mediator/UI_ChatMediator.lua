--[[
  * ui mediator class:: UI_ChatMediator
...
local mediator = class('UI_ChatMediator',pm.Mediator)
...
function mediator:handleNotification(notification)
    ...
    elseif Common.NTF_PLAYER_CHAT == name then 
        self.viewComponent:RecievedMsg(body.msg, body.bIsSelf)
    end 
end
...
function mediator:Opened(param)
    ...
    self.viewComponent:FreshWindow(proxy:GetChatMsg())
end 
