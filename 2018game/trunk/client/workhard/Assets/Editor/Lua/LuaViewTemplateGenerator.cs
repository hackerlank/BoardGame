...
public class LuaViewTemplateGenerator : UnityEditor.ProjectWindowCallback.EndNameEditAction
{
...
function tbclass:Init()
    ...
    if transform == nil then 
        LogError('[$CLASS.Init]:: missing transform')
        return
    end 
...
return tbclass";
	...
	[MenuItem("Assets/Create/Game Lua/Lua View Script")]
	public static void Create() {
		TextAsset Asset = new TextAsset();
		UnityEditor.ProjectWindowUtil.StartNameEditingIfProjectWindowExists (
			Asset.GetInstanceID(), 
			ScriptableObject.CreateInstance<LuaViewTemplateGenerator>(), 
			"Assets.asset",
